<template>
  <div class="di main-wrap " v-loading="audio.waiting">
    ...
    <div v-show="noError">
      ...
      <el-slider v-show="!controlList.noProcess" v-model="sliderTime" :format-tooltip="formatProcessToolTip" @change="changeCurrentTime" class="slider" @mousedown.native="mouseDown" @mouseup.native="mouseUp"></el-slider>
      ...
      <el-tooltip class="item" effect="dark" :content="tips" placement="left"><span class="tips"> {{tips}}</span></el-tooltip>
    </div>
    <div class="error" v-show="!noError">录音文件读取错误</div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changeCurrentTime (index) {
      this.isChange = true
      this.$refs.audio.currentTime = this.$refs.audio.sliderTime = parseInt(index / 100 * this.audio.maxTime)
      this.startPlay()
    },
    startPlayOrPause () {
